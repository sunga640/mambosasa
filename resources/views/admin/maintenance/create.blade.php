...
@section('content')
    ...
    <form method="GET" action="{{ route('admin.maintenance.create') }}" class="form-row mt-20" style="display:flex;gap:1rem;align-items:flex-end;">
        <div>
    ...
    <form method="POST" action="{{ route('admin.maintenance.store') }}" class="mt-30">
        @csrf
        <div class="form-row">
