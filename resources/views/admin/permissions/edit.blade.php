...
@section('content')
    <h1 class="text-30">{{ __('Edit permission') }}</h1>
    <form method="POST" action="{{ route('admin.permissions.update', $permission) }}" class="mt-30">
        @csrf
        @method('PUT')
        <div class="form-row">
        ...
        <div class="form-row">
            ...
            <input id="slug" type="text" name="slug" value="{{ old('slug', $permission->slug) }}">
