    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="account-field-stack">
            ...
            <div class="password-wrapper">
                ...
                <button type="button" onclick="togglePass('password', 'eye-1')" class="password-toggle-btn" aria-label="{{ __('Toggle password visibility') }}">
        ...
        <div class="account-field-stack">
            ...
            <div class="password-wrapper">
                ...
                <button type="button" onclick="togglePass('password_confirmation', 'eye-2')" class="password-toggle-btn" aria-label="{{ __('Toggle password visibility') }}">
        ...
        <div class="auth-form-actions" style="display: flex; justify-content: space-between; align-items: center; gap: 1rem; margin-top: 1.8rem; flex-wrap: wrap;">
            <a class="account-link" href="{{ route('login') }}" style="font-size: 0.92rem;">
                {{ __('Already registered?') }}
            </a>

            <x-primary-button style="width:auto; min-width:11rem; margin-top:0;">
                {{ __('Register') }}
            </x-primary-button>
        </div>
    </form>
